...
const STAR_IMAGE = require('../../assets/images/star/star.png');
const HEART_IMAGE = require('../../assets/images/star/heart.png');
const ROCKET_IMAGE = require('../../assets/images/star/rocket.png');
const BELL_IMAGE = require('../../assets/images/star/bell.png');
...
export default class SwipeRating extends Component {
  static defaultProps = {
    type: 'star',
    ratingImage: require('../../assets/images/star/star.png'),
    ratingColor: '#f1c40f',
  ...
  async componentDidMount() {
    try {
      const STAR_IMAGE = await require('../../assets/images/star/star.png');
      const HEART_IMAGE = await require('../../assets/images/star/heart.png');
      const ROCKET_IMAGE = await require('../../assets/images/star/rocket.png');
      const BELL_IMAGE = await require('../../assets/images/star/bell.png');
